(function(){
  const ROUTE_GROUPS=[
    ...
    {group:'Südstadt',items:['Alte Feuerwehr links','Öko','Busbahnhof VB','Neue Feuerwehr','Grünstraße','Nordstraße – KH Richtung Harzer','Nordstraße – andersrum','Harzer – Richtung Avantgarde','Harzer – andersrum','Talstraße – von oben','Talstraße – von unten']},
